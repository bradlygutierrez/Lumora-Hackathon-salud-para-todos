...
//#endregion
//#region node_modules/toastify-js/src/toastify.js
var require_toastify = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*!
	* Toastify js 1.12.0
	...
	(function(root, factory) {
		...
		Toastify.lib = Toastify.prototype = {
			...
			buildToast: function() {
				...
				else if (this.options.positionLeft === true) {
				...
				if (this.options.node && this.options.node.nodeType === Node.ELEMENT_NODE) divElement.appendChild(this.options.node);
				else {
					...
					if (this.options.avatar !== "") {
						...
						if (this.options.position == "left" || this.options.positionLeft === true) divElement.appendChild(avatarElement);
						else divElement.insertAdjacentElement("afterbegin", avatarElement);
					}
				}
				if (this.options.close === true) {
					...
					if ((this.options.position == "left" || this.options.positionLeft === true) && width > 360) divElement.insertAdjacentElement("afterbegin", closeElement);
					else divElement.appendChild(closeElement);
				}
		...
		Toastify.reposition = function() {
			...
			for (var i = 0; i < allToasts.length; i++) {
				...
				var offset = 15;
				if ((window.innerWidth > 0 ? window.innerWidth : screen.width) <= 360) {
