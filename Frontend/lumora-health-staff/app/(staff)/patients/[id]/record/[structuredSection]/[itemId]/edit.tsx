...
export default function StructuredHistoryEditRoute() {
  ...
  const itemId = Number(first(params.itemId));
  ...
  if (
    ...
    return (
      <ErrorState
        ...
        message="Paciente, expediente o registro inválido para esta edición."
      />
    );
  }

  if (section === 'conditions') {
    return <ConditionFormScreen conditionId={itemId} patientId={patientId} recordId={recordId} />;
  }
  if (section === 'allergies') {
    return <AllergyFormScreen allergyId={itemId} patientId={patientId} recordId={recordId} />;
  }
  if (section === 'disabilities') {
    return <DisabilityFormScreen disabilityId={itemId} patientId={patientId} recordId={recordId} />;
  }
  if (section === 'history') {
    return <MedicalHistoryFormScreen historyId={itemId} patientId={patientId} recordId={recordId} />;
  }
