from lumora_api.schemas.identity import PatientRead, UserRead
...
def test_patient_read_accepts_legacy_persona_email_with_reserved_domain():
    assert PatientRead.model_validate(
        {
            "id": 1,
            "tipo_sangre_id": None,
            "alergias": None,
